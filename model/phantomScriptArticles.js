    ...
    if (status === 'success') {
        ...
        urls = page.evaluate(function() {
            ...
            setTimeout(function() {
                ...
                for(q = 0; q < articles.length; q++){
                    // console.log("image added");
                    console.log(articles[q].href);
                    // if(articles[q].href.indexOf("/imgres?imgurl=http")>0){
                    //     var final_url = decodeURIComponent(articles[q].href).split(/=|%|&/)[1].split("?imgref")[0];
...
// Run the script
page.open('https://www.google.fr/search?q='+system.args[1]+'&source=lnms&tbm=nws', fs);
