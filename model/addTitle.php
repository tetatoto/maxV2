...
function addTitle($videoPath, $videoResultName, $title) {
    ...
    $commandLine = "ffmpeg -i ".$videoPath." -vf drawtext=\"fontfile=model/templates/arial.ttf: text=".$title.": fontcolor=white: fontsize=24: box=1: boxcolor=black@0.5: boxborderw=5: x=10: y=330\" -codec:a copy model/outputs/".$videoResultName;
