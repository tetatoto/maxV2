...
do
    ...
    then
        ffmpeg -y -i model/outputs/generated_video_step2.mp4 -i "$picturePath" -filter_complex "[0:v][1:v] overlay=640-320-3:3:enable='between(t,${current_timeline},${next})'" -pix_fmt yuv420p -c:a copy model/outputs/generated_video_step2.mp4;
